...
public class BraindoNN {
     public double[] avoidanceNeuralNetwork (float ans1, float ans2, float ans3, float ans4, float ans5, float ans6, float ans7, float ans8, float ans9, float ans10){
        NeuralNetwork neuralNetwork = NeuralNetwork.createFromFile("C:\\Users\\Bárbara Fernández\\Documents\\GitHub\\TesisBraindo\\BraindoWebService\\src\\java\\model\\test_model\\NeuralNetworkFiles\\Avoidance.nnet");
        // set network input 
     ...
     public double[] experienceNeuralNetwork (float ans1, float ans2, float ans3, float ans4, float ans5, float ans6, float ans7, float ans8, float ans9, float ans10, float ans11){
        NeuralNetwork neuralNetwork = NeuralNetwork.createFromFile("C:\\Users\\Bárbara Fernández\\Documents\\GitHub\\TesisBraindo\\BraindoWebService\\src\\java\\model\\test_model\\NeuralNetworkFiles\\Experience.nnet");
        // set network input 
     ...
     public double[] flexibilityNeuralNetwork (float ans1, float ans2, float ans3, float ans4){
        NeuralNetwork neuralNetwork = NeuralNetwork.createFromFile("C:\\Users\\Bárbara Fernández\\Documents\\GitHub\\TesisBraindo\\BraindoWebService\\src\\java\\model\\test_model\\NeuralNetworkFiles\\Flexibility.nnet");
        // set network input 
     ...
     public double[] fusionNeuralNetwork (float ans1, float ans2, float ans3, float ans4, float ans5, float ans6, float ans7){
        NeuralNetwork neuralNetwork = NeuralNetwork.createFromFile("C:\\Users\\Bárbara Fernández\\Documents\\GitHub\\TesisBraindo\\BraindoWebService\\src\\java\\model\\test_model\\NeuralNetworkFiles\\Fusion.nnet");
        // set network input 
     ...
     public double[] rigidityNeuralNetwork (float ans1, float ans2, float ans3, float ans4, float ans5, float ans6, float ans7){
        NeuralNetwork neuralNetwork = NeuralNetwork.createFromFile("C:\\Users\\Bárbara Fernández\\Documents\\GitHub\\TesisBraindo\\BraindoWebService\\src\\java\\model\\test_model\\NeuralNetworkFiles\\Rigidity.nnet");
        // set network input 
        neuralNetwork.setInput(ans1, ans2, ans3, ans4, ans5, ans6, ans7);
        neuralNetwork.calculate();
        double[] networkOutput = neuralNetwork.getOutput();
     ...
     public double[] socialAnxietyNeuralNetwork (float ans1, float ans2, float ans3, float ans4, float ans5, float ans6, float ans7, float ans8, float ans9, float ans10, float ans11, float ans12, float ans13,
        ...
        NeuralNetwork neuralNetwork = NeuralNetwork.createFromFile("C:\\Users\\Bárbara Fernández\\Documents\\GitHub\\TesisBraindo\\BraindoWebService\\src\\java\\model\\test_model\\NeuralNetworkFiles\\SocialAnxiety.nnet");
        // set network input 
