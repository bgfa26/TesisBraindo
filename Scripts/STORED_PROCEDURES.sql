...
CREATE OR REPLACE FUNCTION CITA_CONSULTAR_DETALLE(integer) RETURNS TABLE(CODIGO integer, FECHA date, RESPUESTA varchar(120), RESPUESTARED varchar(200), FK_PACIENTE integer, FK_PSICOLOGO integer) AS $$
DECLARE
