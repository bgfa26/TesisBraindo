CREATE OR REPLACE FUNCTION PSICOLOGO_INICIARSESION(PSYCHOEMAIL varchar(80), PSYCHOPASS varchar(50)) RETURNS TABLE(CEDULA integer, EMAIL varchar(80), CLAVE varchar(50), PRIMERNOMBRE varchar(50), SEGUNDONOMBRE varchar(50), PRIMERAPELLIDO varchar(50), SEGUNDOAPELLIDO varchar(50), NUMEROMATRICULA varchar(20), FECHAINGRESO date) AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION PSICOLOGO_REGISTRAR(ID integer, MAIL varchar(80), PASS varchar(50), NAME varchar(50), SECONDNAME varchar(50), SURNAME varchar(50), SECONDSURNAME varchar(50), REGISTRATIONNUMBER varchar(20), BIRTHDATE date) RETURNS integer AS $$
DECLARE
 RESULT integer;
 FK_LUGAR integer;
...
CREATE OR REPLACE FUNCTION DIAGNOSTICO_REGISTRAR(DIAGNOSIS_DATE date, FEELINGS varchar(100), EMOTIONS varchar(100), ANSWER varchar(120), ANSWER_RED varchar(200), PATIENT integer, PSYCHO varchar(80)) RETURNS integer AS $$
DECLARE
 RESULT integer;
 PSICOLOGO integer;
BEGIN
		...
		INSERT INTO DIAGNOSTICO (FECHA, SENTIMIENTOS, EMOCIONES, RESPUESTA, RESPUESTARED, FK_PACIENTE, FK_PSICOLOGO) VALUES (DIAGNOSIS_DATE, FEELINGS, EMOTIONS, ANSWER, ANSWER_RED, PATIENT, PSICOLOGO);
...
CREATE OR REPLACE FUNCTION DIAGNOSTICO_CONSULTAR(PATIENT integer, PSYCHO integer) RETURNS TABLE(CODIGO integer, FECHA date, SENTIMIENTOS varchar(100), EMOCIONES varchar(100), RESPUESTA varchar(120), RESPUESTARED varchar(200), NOMBRE_PACIENTE varchar(50), APELLIDO_PACIENTE varchar(50), NOMBRE_PSICO varchar(50), APELLIDO_PSICO varchar(50)) AS $$
DECLARE

BEGIN
	 RETURN QUERY
	 SELECT D.CODIGO, D.FECHA, D.SENTIMIENTOS, D.EMOCIONES, D.RESPUESTA, D.RESPUESTARED, P.PRIMERNOMBRE, P.PRIMERAPELLIDO, PS.PRIMERNOMBRE, PS.PRIMERAPELLIDO
...
CREATE OR REPLACE FUNCTION DIAGNOSTICO_CONSULTAR_DETALLE(DIAGNOSIS integer) RETURNS TABLE(CODIGO integer, FECHA date, SENTIMIENTOS varchar(100), EMOCIONES varchar(100), RESPUESTA varchar(120), RESPUESTARED varchar(200), NOMBRE_PACIENTE varchar(50), APELLIDO_PACIENTE varchar(50), NOMBRE_PSICO varchar(50), APELLIDO_PSICO varchar(50)) AS $$
DECLARE
