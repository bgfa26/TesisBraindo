...
CREATE OR REPLACE FUNCTION EXAMENMENTAL_REGISTRAR(BEHAVIOR varchar(300), ATTITUDE varchar(200), ALERTNESS varchar(200), AWARENESS varchar(200), MOOD varchar(200), LANGUAGE varchar(200), THOUGHT varchar(300)) RETURNS integer AS $$
DECLARE
 RESULT integer;
