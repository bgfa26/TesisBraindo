...
<asp:Content ID="ContentIndex2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="inline center">
                            <div>
                                <label>Desde: </label>
                                <input runat="server" id="initDate" type="month" class="form-control-DashboardInput"/>
                            </div>
                            <div>
                                <label>Hasta: </label>
                                <input runat="server" id="endDate" type="month"  class="form-control-DashboardInput"/>
                            </div>
                            <div>
    ...
    <script>
        ...
        function SucessDate(response, userContext, methodName) {
            if ((response != "En la fecha consultada no existen registros") && (response != "Seleccione un rango de fecha") && (response != "Deben ser el mismo año")) {
